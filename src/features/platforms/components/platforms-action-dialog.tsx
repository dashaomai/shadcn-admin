...
import { createOrUpdatePlatform, PlatformActionPayload } from '@/api/platform'
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormDescription>
                      {i18n.t(
                        isUpdate
                          ? 'apps.platforms.properties.name.updateDescription'
                  ...
                  <FormItem>
                    ...
                    >
                      ...
                      <SelectContent>
                        ...
                        <SelectItem value='3'>
                          {i18n.t('apps.platforms.properties.type.thirdpart')}
                        </SelectItem>
                      </SelectContent>
                    </Select>
                  </FormItem>
